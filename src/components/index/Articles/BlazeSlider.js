export const BlazeSlider = (function () {
  ...
  function i(t) {
    (t.offset = -1 * t.states[t.stateIndex].page[0]), s(t), n(t);
  }
  function s(t) {
  ...
  function d() {
    ...
    (t.slider.isDragging = !1),
      f(t, "removeEventListener"),
      (t.slider.dragged = 0),
      s(t.slider),
      o(t.slider),
      t.isScrolled || (e < -10 ? t.slider.next() : e > 10 && t.slider.prev());
  }
  const u = (t) => t.preventDefault();
  function f(t, e) {
    t[e]("contextmenu", d),
      a()
        ? (t[e]("touchend", d), t[e]("touchmove", c))
        : (t[e]("pointerup", d), t[e]("pointermove", c));
  }
  const h = {
    slideGap: "20px",
    slidesToScroll: 1,
  ...
  function m(n, i) {
    ...
    (i.slides = o.children),
      ...
      (i.config = n),
      e(i, i.totalSlides, n),
      n.loop || i.el.classList.add(t),
      n.enableAutoplay && !n.loop && (n.enableAutoplay = !1),
      (o.style.transitionProperty = "transform"),
      (o.style.transitionTimingFunction = i.config.transitionTimingFunction),
      (o.style.transitionDuration = `${i.config.transitionDuration}ms`);
    const { slidesToShow: r, slideGap: c } = i.config;
    i.el.style.setProperty("--slides-to-show", r + ""),
      i.el.style.setProperty("--slide-gap", c),
      i.isStatic
        ...
        : n.draggable &&
          (function (t) {
            const e = t.track;
            e.slider = t;
            const n = a() ? "touchstart" : "pointerdown";
  ...
  return class extends class {
      ...
      S(this, l),
        ...
        (function (t, e) {
          ...
          if (t.config.loop) {
            ...
            t.isDragging
              ? a()
                ? t.track.addEventListener("touchend", i, { once: !0 })
                : t.track.addEventListener("pointerup", i, { once: !0 })
              : l(i);
          } else i(t);
        })(this, c);
    }
    ...
    destroy() {
      this.track.removeEventListener(a() ? "touchstart" : "pointerdown", l),
        this.stopAutoplay(),
    ...
    refresh() {
      const t = this.passedConfig ? g(this.passedConfig) : { ...h };
